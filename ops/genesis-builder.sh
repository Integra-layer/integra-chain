...
TREASURY_AMOUNT="99999979600000000000000000000"    # 99,999,979,600 IRL (100B - 4*5100)
VALIDATOR_AMOUNT="5100000000000000000000"           # 5,100 IRL per validator
STAKE_AMOUNT="100000000000000000000"                # 100 IRL self-stake in gentx
MIN_SELF_DELEGATION="1000000000000000000"            # 1 IRL
