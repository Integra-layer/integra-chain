...
func init() {
	...
	// Register Integra chain IDs in the library's ChainsCoinInfo map
	for chainID, coinInfo := range IntegraChainsCoinInfo {
		evmconfig.ChainsCoinInfo[chainID] = coinInfo
	}
}
...
var (
	_ runtime.AppI                = (*IntegraApp)(nil)
	_ cosmosevmserver.Application = (*IntegraApp)(nil)
	_ ibctesting.TestingApp       = (*IntegraApp)(nil)
)
...
// NewIntegraApp returns a reference to an initialized IntegraApp.
func NewIntegraApp(
	logger log.Logger,
	db dbm.DB,
...
func (app *IntegraApp) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
...
func (app *IntegraApp) onPendingTx(hash common.Hash) {
...
func (app *IntegraApp) RegisterPendingTxListener(listener func(common.Hash)) {
	app.pendingTxListeners = append(app.pendingTxListeners, listener)
}

func (app *IntegraApp) setPostHandler() {
...
func (app *IntegraApp) Name() string { return app.BaseApp.Name() }

// BeginBlocker application updates every begin block
func (app *IntegraApp) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *IntegraApp) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

func (app *IntegraApp) FinalizeBlock(req *abci.RequestFinalizeBlock) (res *abci.ResponseFinalizeBlock, err error) {
	return app.BaseApp.FinalizeBlock(req)
}

func (app *IntegraApp) Configurator() module.Configurator {
	return app.configurator
}

// InitChainer application update at chain initialization
func (app *IntegraApp) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *IntegraApp) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.ModuleManager.PreBlock(ctx)
}

// LoadHeight loads a particular height
func (app *IntegraApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// LegacyAmino returns IntegraApp's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *IntegraApp) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns IntegraApp's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *IntegraApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns IntegraApp's InterfaceRegistry
func (app *IntegraApp) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

// TxConfig returns IntegraApp's TxConfig
func (app *IntegraApp) TxConfig() client.TxConfig {
	return app.txConfig
}
...
func (app *IntegraApp) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *IntegraApp) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *IntegraApp) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
	return app.memKeys[storeKey]
}

// SimulationManager implements the SimulationApp interface
func (app *IntegraApp) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *IntegraApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *IntegraApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.GRPCQueryRouter(), clientCtx, app.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *IntegraApp) RegisterTendermintService(clientCtx client.Context) {
...
func (app *IntegraApp) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *IntegraApp) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeperSDK implements the TestingApp interface.
func (app *IntegraApp) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return *app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *IntegraApp) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

func (app *IntegraApp) GetEVMKeeper() *evmkeeper.Keeper {
	return app.EVMKeeper
}

func (app *IntegraApp) GetErc20Keeper() *erc20keeper.Keeper {
	return &app.Erc20Keeper
}

func (app *IntegraApp) SetErc20Keeper(erc20Keeper erc20keeper.Keeper) {
	app.Erc20Keeper = erc20Keeper
}

func (app *IntegraApp) GetGovKeeper() govkeeper.Keeper {
	return app.GovKeeper
}

func (app *IntegraApp) GetEvidenceKeeper() *evidencekeeper.Keeper {
	return &app.EvidenceKeeper
}

func (app *IntegraApp) GetSlashingKeeper() slashingkeeper.Keeper {
	return app.SlashingKeeper
}

func (app *IntegraApp) GetBankKeeper() bankkeeper.Keeper {
	return app.BankKeeper
}

func (app *IntegraApp) GetFeeMarketKeeper() *feemarketkeeper.Keeper {
	return &app.FeeMarketKeeper
}

func (app *IntegraApp) GetFeeGrantKeeper() feegrantkeeper.Keeper {
	return app.FeeGrantKeeper
}

func (app *IntegraApp) GetConsensusParamsKeeper() consensusparamkeeper.Keeper {
	return app.ConsensusParamsKeeper
}

func (app *IntegraApp) GetAccountKeeper() authkeeper.AccountKeeper {
	return app.AccountKeeper
}

func (app *IntegraApp) GetAuthzKeeper() authzkeeper.Keeper {
	return app.AuthzKeeper
}

func (app *IntegraApp) GetDistrKeeper() distrkeeper.Keeper {
	return app.DistrKeeper
}

func (app *IntegraApp) GetStakingKeeper() *stakingkeeper.Keeper {
	return app.StakingKeeper
}

func (app *IntegraApp) GetMintKeeper() mintkeeper.Keeper {
	return app.MintKeeper
}

func (app *IntegraApp) GetPreciseBankKeeper() *precisebankkeeper.Keeper {
	return &app.PreciseBankKeeper
}

func (app *IntegraApp) GetCallbackKeeper() ibccallbackskeeper.ContractKeeper {
	return app.CallbackKeeper
}

func (app *IntegraApp) GetTransferKeeper() transferkeeper.Keeper {
	return app.TransferKeeper
}

func (app *IntegraApp) SetTransferKeeper(transferKeeper transferkeeper.Keeper) {
	app.TransferKeeper = transferKeeper
}

func (app *IntegraApp) GetMempool() sdkmempool.ExtMempool {
...
func (app *IntegraApp) GetTxConfig() client.TxConfig {
	return app.txConfig
}

func (app *IntegraApp) SetClientCtx(clientCtx client.Context) { // TODO:VLAD - Remove this if possible
	app.clientCtx = clientCtx
}

// Close unsubscribes from the CometBFT event bus (if set) and closes the mempool and underlying BaseApp.
func (app *IntegraApp) Close() error {
	var err error
...
func (app *IntegraApp) AutoCliOpts() autocli.AppOptions {
